        ...
        <div class="col-md-12">
          <div class="terms-condition">
            <div class="text-center mb-5">
              ...
              <h5 class="heading-font-color"></h5>
            </div>
            <div class="container">
              <div class="card mb-5">
                <div class="card-body">
                  <div class="content p-3">
                    <h1 class="mt-2 fw-bold">Terms of Use</h1>
                    <hr>
                    <div class="mt-2"
                      style="box-sizing: border-box; color: rgb(33, 37, 41); font-family: arboria-book; font-size: 16px; margin-top: 0.5rem !important;">
                      <p><strong>Terms and Conditions</strong></p>

                      <p>Welcome to WESTLAND MUTUAL INSURANCE!</p>

                      <p>These terms and conditions outline the rules and regulations for the use of American General
                        Insurance Company&#39;s Website, WESTLAND MUTUAL INSURANCE.</p>

                      <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        WESTLAND MUTUAL INSURANCE if you do not agree to take all of the terms and conditions stated on
                        this page.</p>
                      ...
                      <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                        ...
                        stated services, in accordance with and subject to, prevailing law of us. Any use of the above
                      ...
                      <p>We employ the use of cookies. By accessing WESTLAND MUTUAL INSURANCE, you agreed to use cookies
                        in agreement with the American General Insurance Company&#39;s Privacy Policy.</p>
                      ...
                      <p>Unless otherwise stated, American General Insurance Company and/or its licensors own the
                        intellectual property rights for all material on WESTLAND MUTUAL INSURANCE. All intellectual
                        property rights are reserved. You may access this from WESTLAND MUTUAL INSURANCE for your own
                        personal use subjected to restrictions set in these terms and conditions.</p>

                      <p>You must not:</p>

                      <ul>
                        <li>Republish material from WESTLAND MUTUAL INSURANCE</li>
                        <li>Sell, rent or sub-license material from WESTLAND MUTUAL INSURANCE</li>
                        <li>Reproduce, duplicate or copy material from WESTLAND MUTUAL INSURANCE</li>
                        <li>Redistribute content from WESTLAND MUTUAL INSURANCE</li>
                      </ul>

                      <p>This Agreement shall begin on the date hereof.&nbsp;</p>

                      <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. American General Insurance Company does not filter,
                        edit, publish or review Comments prior to their presence on the website. Comments do not reflect
                        the views and opinions of American General Insurance Company,its agents and/or affiliates.
                        Comments reflect the views and opinions of the person who post their views and opinions. To the
                        extent permitted by applicable laws, American General Insurance Company shall not be liable for
                        the Comments or for any liability, damages or expenses caused and/or suffered as a result of
                        any use of and/or posting of and/or appearance of the Comments on this website.</p>

                      <p>American General Insurance Company reserves the right to monitor all Comments and to remove any
                      ...
                      <p>You hereby grant American General Insurance Company a non-exclusive license to use, reproduce,
                      ...
                      <p>We will approve link requests from these organizations if we decide that: (a) the link would
                        ...
                        hyperlink compensates the absence of American General Insurance Company; and (d) the link is in
                      ...
                      <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking
                        to our website, you must inform us by sending an e-mail to American General Insurance Company.
                      ...
                      <p>No use of American General Insurance Company&#39;s logo or other artwork will be allowed for
