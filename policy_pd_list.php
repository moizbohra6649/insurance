<?php 
/* Include PHP File */
if (file_exists(dirname(__FILE__) . '/php/policy_pd_php.php')) {
    require_once(dirname(__FILE__) . '/php/policy_pd_php.php');
}
                                        ...
                                        <table class="table w-100 nowrap" id="basic-1" style="width:100%">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th style="text-align:center;">Policy PD ID</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center"> <?=$get_data["policy_pd_id"]?> </td>
                                                    ...
                                                    <td align="center">
                                                        <a href="<?=$actual_link?>policy_pd.php?id=<?=base64_encode($id)?>&mode=VIEW" target="_blank" class="action-icon m-2"> <i class="icofont icofont-eye-alt"></i></a>
                                                        <a href="<?=$actual_link?>policy_pd.php?id=<?=base64_encode($id)?>&mode=EDIT" target="_blank" class="action-icon m-2"> <i class="icofont icofont-ui-edit"></i></a>
...
<?php include('partial/scripts.php');
    /* Include JS File */
    if (file_exists(dirname(__FILE__) . '/js/policy_pd_js.php')) {
        require_once(dirname(__FILE__) . '/js/policy_pd_js.php');
    }
?>
</body>
</html>