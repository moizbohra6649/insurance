...
$filter_policy_umd_id    = (isset($_REQUEST["filter_policy_umd_id"])) ? $_REQUEST["filter_policy_umd_id"] : "";

$select_query = "SELECT * FROM policy_umd WHERE 1=1 ";
...
if(!empty($filter_policy_umd_id)){
    $select_query .= " AND policy_umd_id = $filter_policy_umd_id ";
}
...
switch ($mode) {
    ...
    case "EDIT":
        $local_mode = "INSERT";
        $readonly   = "readonly";
        $title      = ($mode == "EDIT") ? "Policy UMD Edit" : "Policy UMD View";
