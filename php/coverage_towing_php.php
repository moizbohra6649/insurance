...
$title      = ""; 
$list_title = "List of Coverage Towing (Uninsured Motorist / Bodily Injury)";
$breadcrumb_title = "Coverage Towing (Uninsured Motorist / Bodily Injury)";
$local_mode = "";
$readonly   = "";
...
switch ($mode) {
    case "NEW":
        $local_mode = "INSERT";
        $readonly   = "";
        $title      = "Add New Coverage towing (Uninsured Motorist / Bodily Injury)"; 
    ...
    case "EDIT":
        $local_mode = "INSERT";
        $readonly   = "readonly";
        $title      = ($mode == "EDIT") ? "Edit Coverage Towing (Uninsured Motorist / Bodily Injury)" : "View Coverage Towing (Uninsured Motorist / Bodily Injury)";
