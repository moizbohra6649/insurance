                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-sm-6 col-auto">
                                        <div class="text-sm-end">
                                            <a href="<?=$actual_link?>customer.php" class="btn btn-primary mb-2"><i class="icon-plus"></i> Add</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <a href="<?=$actual_link?>customer.php?id=<?=base64_encode($id)?>&mode=EDIT" target="_blank" class="action-icon"> <i class="icofont icofont-ui-edit"></i></a>
