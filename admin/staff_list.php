                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-sm-6 col-auto">
                                        <div class="text-sm-end">
                                            <a href="<?=$actual_link?>staff.php" class="btn btn-primary mb-2"><i class="icofont icofont-plus"></i> Add New Staff</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="form-row-preview">
                                        <form method="GET" id="staff_list">
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    <label for="filter_staff_name" class="form-label">Staff Name</label>
                                                    <input type="text" class="form-control" id="filter_staff_name" name="filter_staff_name" placeholder="Staff Name" value="<?=$filter_staff_name?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <a href="<?=$actual_link?>staff.php?id=<?=base64_encode($id)?>&mode=EDIT" target="_blank" class="action-icon m-2"> <i class="icofont icofont-ui-edit"></i></a>
