                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div id="image_preview_div" style="display:<?= ($local_mode != 'NEW') ? 'block': 'none';?>;">
                                                <?php
                                                    if(!empty($profile_image) && file_exists(dirname(__FILE__) . '/' . $upload_folder . '/vendor_profile_picture/' . $profile_image)){
                                                        $profile_image_url = $upload_folder . "/vendor_profile_picture/$profile_image"; 
                                                    ?>
                                                <div class="input-group">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div id="image_preview_div2" style="display:<?= ($local_mode != 'NEW') ? 'block': 'none';?>;">
                                                <?php
                                                    if(!empty($business_licence_image) && file_exists(dirname(__FILE__) . '/' . $upload_folder . '/vendor_licence/' . $business_licence_image)){
                                                        $business_licence_image_url = $upload_folder . "/vendor_licence/$business_licence_image"; 
                                                    ?>
                                                <div class="input-group">
