                                ...
                                <input type="hidden" name="mode" value="<?=$local_mode?>" />
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input class="form-control onlytext" id="tra_type" name="tra_type" type="text" value="<?=$transaction_type?>" placeholder="Transaction Type" required="">
                                            <div class="invalid-feedback">Please fill Transaction Type.</div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="tra_id">Transaction ID<span class="text-danger">*</span></label>
                                                ...
                                                <input class="form-control alpha_num" id="tra_id" name="tra_id" type="text" value="<?=$transaction_id?>" placeholder="Transaction ID" aria-describedby="inputGroupPrepend" required="">
                                                <div class="invalid-feedback">Please fill Transaction ID.</div>
