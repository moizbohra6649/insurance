...
$date_of_issue         = (isset($_REQUEST["date_of_issue"]) && !empty($_REQUEST["date_of_issue"])) ? convertToYMD($_REQUEST["date_of_issue"]) : "0000-00-00";
$date_of_expiry        = (isset($_REQUEST["date_of_expiry"]) && !empty($_REQUEST["date_of_expiry"])) ? convertToYMD($_REQUEST["date_of_expiry"]) : "0000-00-00";
