...
$title      = ""; 
$list_title = "List of Policy PD (Property Damage)";
$breadcrumb_title = "Policy PD (Property Damage)";
$local_mode = "";
$readonly   = "";
...
if(isListInPageName(pathinfo($_SERVER['PHP_SELF'], PATHINFO_FILENAME))){
    $select_query = "SELECT * FROM policy_pd";
...
switch ($mode) {
    case "NEW":
        $local_mode = "INSERT";
        $readonly   = "";
        $title      = "Add New Policy PD (Property Damage)"; 
    ...
    case "EDIT":
        $local_mode = "INSERT";
        $readonly   = "readonly";
        $title      = ($mode == "EDIT") ? "Edit Policy PD (Property Damage)" : "View Policy PD (Property Damage)";
