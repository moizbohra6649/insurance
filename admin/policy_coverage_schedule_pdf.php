...
$html_body .= get_policy_coverage_schedule_pdf($policy_data, $base64, $barcode_policy_no, $vehicle_amount);
...
function get_policy_coverage_schedule_pdf($policy_data, $base64, $barcode_policy_no, $vehicle_amount){
...
<script>
    async function generatePDF() {
        ...
        const page_1 = document.getElementById("print-area");
        ...
        pdf.save("policy_coverage_schedule.pdf");
    }
