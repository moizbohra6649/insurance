                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <div class="media-body text-end icon-state">
                                                            <label class="switch">
                                                                <input type="checkbox" <?=(empty($get_data["status"])) ? "checked" : "" ; ?> class="status" id="status_<?=($id)?>" onchange="fn_status_change('<?=base64_encode($id)?>', 'users');"><span class="switch-state"></span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td align="center">
