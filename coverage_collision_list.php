                                ...
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-sm-12 col-auto">
                                        <div class="text-sm-end">
                                            <a href="<?=$actual_link?>coverage_collision.php" class="btn btn-primary mb-2"><i class="icofont icofont-plus"></i> Add New Coverage Collision</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table w-100 nowrap" id="basic-1" style="width:100%">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th style="text-align:center;">Coverage Collision ID</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center"> <?=$get_data["coverage_collision_id"]?> </td>
                                                    ...
                                                    <td align="center">
                                                        <a href="<?=$actual_link?>coverage_collision.php?id=<?=base64_encode($id)?>&mode=VIEW" target="_blank" class="action-icon m-2"> <i class="icofont icofont-eye-alt"></i></a>
                                                        <a href="<?=$actual_link?>coverage_collision.php?id=<?=base64_encode($id)?>&mode=EDIT" target="_blank" class="action-icon m-2"> <i class="icofont icofont-ui-edit"></i></a>
