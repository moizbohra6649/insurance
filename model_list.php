                                ...
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-sm-12 col-auto">
                                        <div class="text-sm-end">
                                            <a href="<?=$actual_link?>model.php" class="btn btn-primary mb-2"><i class="icofont icofont-plus"></i> Add New Model</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table w-100 nowrap" id="basic-1" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center"> <?=$get_data["model_name"]?> </td>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <a href="<?=$actual_link?>model.php?id=<?=base64_encode($id)?>&mode=EDIT" target="_blank" class="action-icon m-2"> <i class="icofont icofont-ui-edit"></i></a>
