...
--
-- Table structure for table `policy_medical`
--

CREATE TABLE `policy_medical` (
  `id` int(11) NOT NULL,
  `policy_medical_id` bigint(22) NOT NULL,
  `prefix_policy_medical_id` varchar(252) NOT NULL,
...
--
-- AUTO_INCREMENT for table `policy_medical`
--
ALTER TABLE `policy_medical`
