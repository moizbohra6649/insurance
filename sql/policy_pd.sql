...
--
-- Table structure for table `policy_pd`
--

CREATE TABLE `policy_pd` (
  `id` int(11) NOT NULL,
  `policy_pd_id` bigint(22) NOT NULL,
  `prefix_policy_pd_id` varchar(252) NOT NULL,
...
--
-- AUTO_INCREMENT for table `policy_pd`
--
ALTER TABLE `policy_pd`
