...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2025 at 11:23 PM
...
CREATE TABLE `vehicle` (
  `id` int(11) NOT NULL,
  `vehicle_id` bigint(22) NOT NULL,
  `prefix_vehicle_id` varchar(252) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `vehicle_no` varchar(252) DEFAULT NULL,
  `vehicle_type` varchar(252) DEFAULT NULL,
  `licence_plat_no` varchar(252) DEFAULT NULL,
  `vehicle_year_id` int(11) DEFAULT NULL,
