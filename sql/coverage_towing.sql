...
--
-- Table structure for table `coverage_towing`
--

CREATE TABLE `coverage_towing` (
  `id` int(11) NOT NULL,
  `coverage_towing_id` bigint(22) NOT NULL,
  `prefix_coverage_towing_id` varchar(252) NOT NULL,
...
--
-- AUTO_INCREMENT for table `coverage_towing`
--
ALTER TABLE `coverage_towing`
