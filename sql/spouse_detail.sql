...
--
-- Table structure for table `spouse_detail`
--

CREATE TABLE `spouse_detail` (
  `id` int(11) NOT NULL,
  ...
  `zip_code` int(52) DEFAULT NULL,
  `apt_unit` int(252) DEFAULT NULL,
...
--
-- Indexes for table `spouse_detail`
--
ALTER TABLE `spouse_detail`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `spouse_detail`
--
ALTER TABLE `spouse_detail`
