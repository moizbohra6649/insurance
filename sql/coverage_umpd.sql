...
--
-- Table structure for table `coverage_umpd`
--

CREATE TABLE `coverage_umpd` (
  `id` int(11) NOT NULL,
  `coverage_umpd_id` bigint(22) NOT NULL,
  `prefix_coverage_umpd_id` varchar(252) NOT NULL,
...
--
-- AUTO_INCREMENT for table `coverage_umpd`
--
ALTER TABLE `coverage_umpd`
