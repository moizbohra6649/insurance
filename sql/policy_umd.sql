...
--
-- Table structure for table `policy_umd`
--

CREATE TABLE `policy_umd` (
  `id` int(11) NOT NULL,
  `policy_umd_id` bigint(22) NOT NULL,
  `prefix_policy_umd_id` varchar(252) NOT NULL,
...
--
-- AUTO_INCREMENT for table `policy_umd`
--
ALTER TABLE `policy_umd`
